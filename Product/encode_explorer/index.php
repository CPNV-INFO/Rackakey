...
//
$_CONFIG['main_title'] = "Gestion des données - Rack à clés USB";
...
//
$_CONFIG['users'] = array(array("root", "root", "admin"));
...
//
$_CONFIG['upload_dirs'] = array("./Rack1_Usb1/","./Rack1_Usb2/","./Rack1_Usb3/","./Rack1_Usb4/","./Rack1_Usb5/","./Rack1_Usb6/","./Rack1_Usb7/","./Rack2_Usb1/","./Rack2_Usb2/","./Rack2_Usb3/","./Rack2_Usb4/","./Rack2_Usb5/","./Rack2_Usb6/","./Rack2_Usb7/");
...
//
if (isset($_GET["usbRack"]))
{
	$_CONFIG['starting_dir'] = "Rack".$_GET["usbRack"]."_Usb".$_GET["usbKeyPort"];
}
else
{
...
// Need to be changed to support upload of folder(s).
...
<form enctype="multipart/form-data" method="post">
	<div id="upload">
		...
		<div id="upload_container">
			<!-- Add webkitdirectory mozdirectory parameter to enable upload of folder(s), but function uploadfile() don't support it -->
...
?>
<a href="../index.html"><input type="button" value="Retourner à la gestion des clés USB" style="font-weight: bold; background-color: #008CBA; color: white; height: 30px;"></a>
</div>
<!-- END: Info area -->
</body>
</html>
